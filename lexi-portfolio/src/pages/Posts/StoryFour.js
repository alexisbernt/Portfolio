...
function StoryFour() {
  ...
  return (
    <div style={container}>
      ...
      {/* Title */}
      <h1 style={titleStyle}>
        Collaborating with Amber Ferguson: Awareness, Culture, and Professionalism
      </h1>

      <p style={subtitle}>
        A conversation that connected media, culture, and real-world trends. Also why her help mattered early in my career.
      </p>
